    ...
    <div class="container">
        ...
        <div class="order-lg-last btn-group">
            ...
            <div class="dropdown-menu dropdown-menu-right">
                ...
                <div class="dropdown-item d-flex align-items-start" href="#">
                    <div class="img" style="background-image: url(views/images/prod-2.jpg);"></div>
                    <div class="text pl-3">
                ...
                <div class="dropdown-item d-flex align-items-start" href="#">
                    <div class="img" style="background-image: url(views/images/prod-3.jpg);"></div>
                    <div class="text pl-3">
                        <h4>Citadelle</h4>
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown active">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdown04">
                        ...
                        <a class="dropdown-item" href="products_single">Single Product</a>
