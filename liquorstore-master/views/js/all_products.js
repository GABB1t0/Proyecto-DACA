...
const d = document,
$lista_productos_all_products = d.querySelector('#lista_productos_all_products');
...
d.addEventListener('DOMContentLoaded',  async e => {
    ...
    const template_productos_all_products = d.querySelector('#template_productos_all_products').content;

    //Mostramos los productos por pantalla
    show_products(data_products.success,template_productos_all_products,$lista_productos_all_products);
