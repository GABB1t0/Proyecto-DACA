...
import { validarCamposVacios, validarExpresion, validarNombres_Apellidos, validar_usuario } from "./validaciones.js";
    ...
    if($tabNewAdmin !== null){
        ...
        d.addEventListener('click', async ev => {
            ...
            if(ev.target === $btn_addAdmin){
                ...
                let arrayInputs = [name, last_name, primera_pregunta, primera_respuesta, segunda_pregunta, segunda_respuesta, user_name, password];
1
