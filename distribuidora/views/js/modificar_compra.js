...
import { validarCamposVacios, validar_numero_control,validar_numero_factura, validarExpresion, validarNumeros } from "./validaciones.js";

const {get_sessiones, url_compra} = url;

const d = document,
$modificar_compra = d.querySelector('#modificar_compra');
let datos_compra;
...
d.addEventListener("DOMContentLoaded", e=> {
    ...
    if($modificar_compra){
        ...
        extraer_id_compra(get_sessiones);
