...
const d = document,
$modificar_compra_productos = d.querySelector('#modificar_compra_productos'),
...
const addProduct_in_array_product = (id_producto, cantidad, precio) => {
    ...
    let nombre_producto = `${datos_producto[0]['nombre_producto']} ${datos_producto[0]['contenido_neto']}L`;
...
d.addEventListener('DOMContentLoaded', async e => {
    ...
    if($modificar_compra_productos){
        ...
        console.log(typeof data_compra_productos)
        ...
        d.addEventListener('click', async ev => {
            ...
            //Guardamos datos de la compra
            if(ev.target === $btn_registrar_compra){
