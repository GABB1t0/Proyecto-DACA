...
import {validarCamposVacios, validarExpresion, validarNumeros, validar_numero_control, validar_numero_factura} from "./validaciones.js";
import { alerta } from "./utils.js";

const {url_compra} = url;
const d = document,
$suministros = d.querySelector('#suministros');
...
d.addEventListener('DOMContentLoaded', e=> {
    ...
    if($suministros !== null){
        ...
        d.addEventListener('submit', async ev => {
            ...
            if(!validarCamposVacios(arrayInputs) || !validar_numero_factura(numero_factura) || !validar_numero_control(numero_control) || !validarExpresion(nombre_proveedor) || !validarNumeros(precio_compra)){
                return;
            }
            ...
            //crearVariableSessionSuministros(data,url_sesiones);
        });
    }
});