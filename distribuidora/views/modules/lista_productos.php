				...
				<div class="mdl-cell mdl-cell--4-col-phone mdl-cell--8-col-tablet mdl-cell--12-col-desktop">
					<form action="#">
						<div class="mdl-textfield mdl-js-textfield mdl-textfield--expandable">
							...
							<div class="mdl-textfield__expandable-holder">
								<input class="mdl-textfield__input buscadorcito" type="text" pattern="-?[0-9- ]*(\.[0-9]+)?" id="searchProduct" placeholder="Ingrese Código de Producto">
					...
					<nav class="full-width menu-categories">
						<ul class="list-unstyle text-center">
							<li><a href="lista_productos" class="principal-tabs__a active acceso">Productos Totales</a></li>
							<li><a href="lista_productos_venta" class="principal-tabs__a acceso">Productos en Venta</a></li>
						</ul>
					</nav>
					<div class="full-width text-center" style="padding: 30px 0;" id="lista_productos"></div>
				</div>
			</div>
