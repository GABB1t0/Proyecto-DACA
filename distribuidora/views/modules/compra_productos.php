		...
		<div class="mdl-grid">
			<div class="mdl-cell mdl-cell--12-col">
				<div class="full-width panel mdl-shadow--2dp">
					...
					<div class="full-width panel-content" id="compra_productos">
						<form>
							<div class="mdl-grid">
								<div class="mdl-cell mdl-cell--12-col">
							...
							<p class="text-center">
								<button class="mdl-button mdl-js-button mdl-button--fab mdl-button--colored bg-primary" id="btn-registrar-compra" type="button">
									<i class="zmdi zmdi-plus"></i>
								</button>
								<div class="mdl-tooltip" for="btn-registrar-compra">Registrar Compra</div>
							</p>
						</form>
					</div>
				</div>
...
<?php 
    ...
    echo '<script src="views/js/compra_productos.js" type="module"></script>';
?>
