		...
		<div class="mdl-grid">
			<div class="mdl-cell mdl-cell--12-col">
				<div class="full-width panel mdl-shadow--2dp">
					...
					<div class="full-width panel-content" id="suministros">
						<form>
							<div class="mdl-grid">
								<div class="mdl-cell mdl-cell--12-col">
								...
								<div class="mdl-cell mdl-cell--4-col mdl-cell--8-col-tablet">
									<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
										<input class="mdl-textfield__input" type="number" id="precio_compra">
										<label class="mdl-textfield__label" for="precio_compra">Precio Total de la Compra</label>
