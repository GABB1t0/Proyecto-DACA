				...
				<div class="full-width panel mdl-shadow--2dp">
					...
					<div class="full-width panel-content" id="visualizar_compra">
						<form>
							<div class="mdl-grid">
								<div class="mdl-cell mdl-cell--12-col">
		                            <legend class="text-condensedLight"><i class="zmdi zmdi-border-color"></i> &nbsp; Datos del Suministro</legend><br>
		                        </div>
								...
								<div class="mdl-cell mdl-cell--4-col mdl-cell--8-col-tablet">
									<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label" id="label_precio_compra">
										<input class="mdl-textfield__input" type="number" id="precio_compra" readonly>
